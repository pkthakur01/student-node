...
const errorConfig = require("../configs/error_message_config.json");
...
exports.addStudent = async (newUser) => await pg.query('INSERT INTO students(student_id, name, age, mark1, mark2, mark3, created_at, updated_at)VALUES ($1, $2, $3, $4, $5, $6, $7, $8)'
